...
<!-- Navigation -->
<nav class="side line medium left">
  ...
  <div class="content">
    <div class="container">
      <div class="wrap">
		...
		<div class="fix-1-12">
        	<img height="90" class="wide ae-1 fromCenter" src="assets/svg/logo1.png" alt="" >
        </div>
          ...
          <ul class="grid fixedSpaces equal left grid-71">
            ...
            <li class="col-4-12 ae-4">
              <a href="#" class="cell-71 rounded equalElement">    
                ...
                <p class="tiny opacity-6">TWEET</p>
              </a>
            </li>
            ...
            <li class="col-4-12 ae-4">
              <a href="#" class="cell-71 rounded equalElement last">    
                <h3>Positive/Negative</h3>
                <p class="tiny opacity-6">COMMENT</p>
              </a>
            </li>
  ...
  <div class="content">
    <div class="container">
      <div class="wrap">
        ...
        <div class="fix-8-12">
          <h1 class="huge ae-1 margin-bottom-3">Enter your tweet here.</h1>
          <form action="#" autocomplete="off" class="slides-form margin-bottom-3">
            <textarea class="left wide ae-2" id="tweet" type="text" name="tweet" placeholder="Enter text here" required></textarea>
            <button type="button" class="button big wide green gradient ae-3 fromRight" name="predict" id="predict" >Predict</button>
          </form>
        </div>
      	...
      	<nav class="panel bottom  ">
  			<div class="sections">
    			<div class="center">
    				...
    				<h1 class="ae-4 margin-bottom-2">Developers</h1>

      				<ul class="menu crop">

      					<li><div class="fix-1-12 ae-5">
        					<img height="100" class="wide ae-1 fromCenter" src="assets/svg/veeru.png" alt="" >
        				</div></li>
      					<li><div class="fix-1-12 ae-6">
        					<img height="100" class="wide ae-1 fromCenter" src="assets/svg/shubham.png" alt="" >
        				</div></li>
        				<li><div class="fix-1-12 ae-7">
        					<img height="100" class="wide ae-1 fromCenter" src="assets/svg/nihal.png" alt="" >
        				</div></li>
        				<li><div class="fix-1-12 ae-8">
        					<img height="100" class="wide ae-1 fromCenter" src="assets/svg/sajidyana.png" alt="" >
        				</div></li>
        				<li><div class="fix-1-12 ae-9">
        					<img height="100" class="wide ae-1 fromCenter" src="assets/svg/rishu.png" alt="" >
        				</div></li>
